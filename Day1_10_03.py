...
''' Prblem 1: Print this poem as output as it is:
জটাটবীগলজ্জলপ্রবাহপাবিতস্থলে
গলেবলংব্য় লংবিতাং ভুজংগতুংগমালিকাম্ ।
ডমড্ডমড্ডমড্ডমন্নিনাদবড্ডমর্বয়ং
...
কলানিধানবংধুরঃ শ্রিয়ং জগদ্ধুরংধরঃ ॥ 8 ॥
...
দৃষদ্বিচিত্রতল্পয়োর্ভুজংগমৌক্তিকস্রজোর্-
-গরিষ্ঠরত্নলোষ্ঠয়োঃ সুহৃদ্বিপক্ষপক্ষয়োঃ ।
তৃষ্ণারবিংদচক্ষুষোঃ প্রজামহীমহেংদ্রয়োঃ
...
বিমোহনং হি দেহিনাং সুশংকরস্য় চিংতনম্ ॥ 14 ॥

পূজাবসানসময়ে দশবক্ত্রগীতং যঃ
শংভুপূজনপরং পঠতি প্রদোষে ।
তস্য় স্থিরাং রথগজেংদ্রতুরংগয়ুক্তাং
...
'''Problem 2: Use an external module and use it to perform an operation of your interest.'''

'''Answer
To achive the above I am installing PyJokes using: pip install pyjokes
PS A:\Learning\Python> pip install pyjokes
Collecting pyjokes
...
'''
There is another interesting module known as pyttsx3: pip install pyttsx3
...
'''
Problem 3: Write a python program to add 2 numbers:
'''

a = int(input("Type the 1st number: "))
b = int(input("Type the 2nd number: "))

print(f"The sum of {a} and {b} is {a + b} and avarage is: {(a + b) // 2} and squre of 1st number is {a**2} and 2nd number is {b**2}")

if a > b: print(f"1st number is grater then 2nd")
if a == b: print(f"1st number is equal to 2nd")
if a < b: print(f"1st number is less then 2nd")

'''
Problem 4: Write a python program to find reminder when devided by z
'''

c = a + b

z = int(input("Type the number of Z: "))
print(f"The reminder is: {c % z}")

'''
Problem 4: Write a python program to check the type of variables using input function
'''
